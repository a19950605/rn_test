  ...
  return(
    <View>
      ...
      <View style={{flexDirection:'row'}}>
             <View style={{borderColor:'blue',borderWidth:1,borderRadius:2,padding:10,flexDirection:'row',marginRight:5}}><Text style={{color:'blue'}}>Add</Text></View>
        <View style={{borderColor:'blue',borderWidth:1,borderRadius:2,padding:10,flexDirection:'row' }}><Text style={{color:'blue'}}>2022-12-06 12:26:43</Text></View>
      ...
      <View>
        <View style={{backgroundColor:'transparent',marginLeft:5,marginRight:5,padding:10}}>
           <View style={{flexDirection:'row'}}>
              <Text style={{color:'black',fontWeight:'bold'}}>Alarm ID: </Text>
              <Text>408</Text>
           </View>
            <View style={{flexDirection:'row'}}>
            ...
            <View style={{flexDirection:'row'}}>
              <Text style={{color:'black',fontWeight:'bold'}}>Controller ID: </Text>
              <Text>C001</Text>
           </View> 
            <View style={{flexDirection:'row'}}>
            ...
            <View style={{flexDirection:'row'}}>
              <Text style={{color:'black',fontWeight:'bold'}}>Triggered Datetime: </Text>
           ...
           <View style={{flexDirection:'row',marginLeft:5,marginRight:5,justifyContent:'space-around',backgroundColor:'#fafcff',marginBottom:2}}>
              <View><Text  style={{padding:10,color:'blue'}}>Details</Text></View>
              <View><Text  style={{padding:10,color:'blue'}}>Control</Text></View>
           </View>
      </View>
