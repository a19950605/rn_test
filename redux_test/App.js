...
import { View, Text, Button ,SafeAreaView,Image,StyleSheet, Platform, StatusBar} from 'react-native';
...
function CustomDrawerContent(props) {
    const BASE_PATH =
    'https://upload.wikimedia.org/wikipedia/en/b/b9/';
  ...
  return (
    ...
    <View style={{backgroundColor:'black',padding:10}}>
          <Image
        source={{ uri: 'https://static.wikia.nocookie.net/logopedia/images/1/16/120724090720-MTR-Corporation-logo.png' }}
    ...
    <DrawerContentScrollView {...props} contentOptions={{
